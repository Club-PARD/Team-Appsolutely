...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DataService>(builder: (context, dataService, _) {
      return Scaffold(
        appBar: AppBar(
          title: Text('${authService.displayName}님 환영합니다!'),
          actions: [
            IconButton(
              onPressed: () {
                dataService.create("dummy", authService.uid!);
              },
          ...
          children: [
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: dataService.read(authService.uid!),
